...
namespace Test
{
    ...
    public static class CoIsolationTests
    {
        ...
        public static void TestCoIsolation()
        {
            ...
            new ClassicSearchEngine(allPsmsArray, myMsDataFile, listOfSortedms2Scans, variableModifications, fixedModifications, proteinList, lp, searchModes, CommonParameters, new List<string>()).Run();
