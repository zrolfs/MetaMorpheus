...
namespace Test
{
    ...
    public static class MyPeptideTest
    {
        ...
        public static void TestIdenticalPeaks()
        {
            ...
            ClassicSearchEngine cse = new ClassicSearchEngine(globalPsmss, arrayOfSortedMS2Scans, new List<Modification>(), new List<Modification>(), new List<Protein> { prot }, new OpenSearchMode(), CommonParameters, new List<string>());
