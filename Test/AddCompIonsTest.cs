...
namespace Test
{
    ...
    internal static class AddCompIonsTest
    {
        ...
        public static void TestAddCompIonsClassic()
        {
            ...
            new ClassicSearchEngine(allPsmsArray, myMsDataFile, listOfSortedms2Scans, variableModifications, fixedModifications, proteinList, new List<ProductType> { ProductType.B, ProductType.Y }, searchModes, CommonParameters, new List<string>()).Run();
            ...
            new ClassicSearchEngine(allPsmsArray2, myMsDataFile, listOfSortedms2Scans, variableModifications, fixedModifications, proteinList, new List<ProductType> { ProductType.B, ProductType.Y }, searchModes, CommonParameters2, new List<string>()).Run();
